...
unsigned long render::fonts::name;
unsigned long render::fonts::flags;
unsigned long render::fonts::weapon;
unsigned long render::fonts::watermark;

void render::initialize() {
	render::fonts::name = interfaces::surface->font_create();
	render::fonts::flags = interfaces::surface->font_create();
	render::fonts::weapon = interfaces::surface->font_create();
	render::fonts::watermark = interfaces::surface->font_create();

	interfaces::surface->set_font_glyph(render::fonts::name, "Tahoma", 11, 75, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::flags, "Tahoma", 11, 75, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::weapon, "Tahoma", 11, 75, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::watermark, "Tahoma", 11, 75, 0, 0, font_flags::fontflag_dropshadow);
...
void render::draw_filled_triangle(std::array<vec2_t, 3>points, color color)
{
